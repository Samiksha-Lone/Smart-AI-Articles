  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-32 -left-32 w-[420px] h-[420px] bg-violet-100 rounded-full blur-3xl opacity-50" />
        <div className="absolute -bottom-32 -right-32 w-[420px] h-[420px] bg-indigo-100 rounded-full blur-3xl opacity-50" />
      </div>
      ...
      <div className="relative w-full max-w-[400px] animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1.5">Start enhancing content with AI — free</p>
        </div>
